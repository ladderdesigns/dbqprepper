      ...
      <div className="self-center w-3/4 px-8 my-4 text-center bg-gray-200 rounded-lg shadow-lg">
        ...
        <div className="flex flex-col justify-between px-6 py-4">
          ...
          <div className="flex flex-col justify-center w-full">
            {link && (
              <button
                className="px-4 py-2 mb-4 text-sm font-bold leading-tight bg-white border border-gray-400 rounded-full shadow appearance-none md:block hover:border-gray-500 focus:outline-none focus:shadow-outline"
